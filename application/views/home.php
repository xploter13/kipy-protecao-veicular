                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="section-title style2">
                                <div class="title-header">
                                    <h3></h3>
                                    <h2 class="title">Proteção para você e o seu veículo ficarem tranquilos.</h2>
                                </div>
                                <div class="title-desc">
                                    <p>Aqui, dá pra fazer tudo 100% online sempre que precisar. Você faz a cotação, contrata e garante a proteção para o seu carro ou moto sem sair de casa. É rápido e fácil. Conheça os nossos principais benefícios.</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- row end -->
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="ttm-tabs ttm-tab-style-01" data-effect="fadeIn">
                                <ul class="tabs text-center clearfix">
                                    <li class="tab"><a href="#"><i class="flaticon flaticon-idea"></i>Furto / Roubo</a></li>
                                    <li class="tab"><a href="#"><i class="flaticon flaticon-employee"></i>Incêndio</a></li>
                                    <li class="tab active"><a href="#"><i class="flaticon flaticon-organization"></i>Colição</a></li>
                                    <li class="tab"><a href="#"><i class="flaticon flaticon-corporate"></i>Perda Total</a></li>
                                    <!-- <li class="tab"><a href="#"><i class="flaticon flaticon-money"></i>Fe</a></li>
