...
<head>
    ...
    <title>Kipy Proteção Veicular .: Simulação :.</title>
                                ...
                                <div class="layer-content">
                                    <form id="contact_form" class="contact_form wrap-form clearfix" method="post" novalidate="novalidate" action="#">
                                        <div class="row ttm-boxes-spacing-15px">
                                            ...
                                            <div class="col-md-12 ttm-box-col-wrapper">
                                                <label>
                                                    <span class="text-input margin_bottom0"><input name="name" type="text" value="" placeholder="Seu nome completo" required="required"></span>
                                                </label>
                                            </div>
                                            <div class="col-md-6 ttm-box-col-wrapper">
                                                <label>
                                                    <span class="text-input margin_bottom0"><input name="brand" type="text" value="" placeholder="Marca do Veículo" required="required"></span>
                                                </label>
                                            </div>
                                            <div class="col-md-6 ttm-box-col-wrapper">
                                                <label>
                                                    <span class="text-input margin_bottom0"><input name="model" type="text" value="" placeholder="Modelo do Veículo" required="required"></span>
                                                </label>
                                            </div>
                                            <div class="col-md-6 ttm-box-col-wrapper">
                                                <label>
                                                    <span class="text-input margin_bottom0"><input name="year" type="text" value="" placeholder="Ano" required="required"></span>
                                                </label>
                                            </div>
                                            <div class="col-md-6 ttm-box-col-wrapper">
                                                <label>
                                                    <span class="text-input margin_bottom0"><input name="email" type="text" value="" placeholder="Email" required="required"></span>
                                                </label>
                                            </div>
                                            <div class="col-md-12 ttm-box-col-wrapper">
                                                <label>
                                            ...
                                            <div class="col-md-12 ttm-box-col-wrapper">
                                                <label>
                                                    <span class="text-input margin_bottom0"><textarea name="message" rows="3" placeholder="Observação" required="required"></textarea></span>
                                                </label>
                                            </div>
                                        </div>
                                        <button class="submit ttm-btn ttm-btn-size-lg ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor w-100" type="submit">ENVIAR</button>
                                    </form>
                                </div>
                            </div>
                        </div>
