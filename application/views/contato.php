        ...
        <div class="site-main">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="section-title without-seperator title-style-center_text">
                                <div class="title-header">
                                    <h3>Sua proteção está <strong style="font-size: 22px;">AQUI!</strong></h3>
                                    <h2 class="title text-uppercase" style="color: #303493;">Fale Conosco</h2>
                                </div>
                                <div class="title-desc">
                                    <p>Somos especialista em proteção veicular e fazemos de tudo <br> para que o seu veículo fique <strong style="font-size: 18px;">100%</strong> protegido.</p>
                                </div>
                            ...
                            <div class="padding_right30 res-991-padding_right0 res-991-margin_bottom30">
                                ...
                                <div class="featured-icon-box icon-align-before-content style11">
                                    ...
                                    <div class="featured-content">
                                        <div class="featured-title">
                                            <h3>Ligue (Horário Comercial)</h3>
                                        </div>
                                        <div class="featured-desc"><strong style="color: #223645;"><img src="<?php echo base_url(); ?>assets/images/icons/telephone.png" style="width: 20px; height: auto;" alt="Telephone"> 0800 444 8800</strong></div>
                                        <div class="featured-desc"><strong style="color: #223645;"><img src="<?php echo base_url(); ?>assets/images/icons/whatsapp.png" style="width: 25px; height: auto;" alt="Whatsapp"> (24) 99839-5123</strong></div>
                                    </div>
                                ...
                                <div class="featured-icon-box icon-align-before-content style11">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">Segunda à Sexta: 8h às 17h</div>
                                        <div class="featured-desc">Sábado 8h à 12h</div>
                                    </div>
                                </div><!-- featured-icon-box end-->
                                <div class="ttm-horizontal_sep width-100 margin_top20 margin_bottom20"></div>
                                <!--featured-icon-box-->
            ...
            <div id="google_map" class="google_map">
                <div class="map_container clearfix">
                    <div id="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3687.275878790076!2d-43.81553088504252!3d-22.45626488524275!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9eb568e1c28ca5%3A0xc6c1e2120b636408!2sR.%20Jos%C3%A9%20Alves%20Pimenta%2C%201861%20-%20Matadouro%2C%20Barra%20do%20Pira%C3%AD%20-%20RJ%2C%2027115-010!5e0!3m2!1spt-BR!2sbr!4v1622466176352!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>                    
                </div>
            </div>
        </div><!--site-main end-->
